...
const Dashboard = () => {
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      const [categoryRes, paymentRes, monthlyRes, transactionsRes] =
        await Promise.all([
          axios
            .get(`${baseURL}/transaction/stats/category`, { withCredentials: true })
            .catch(() => ({ data: { data: [] } })),
          axios
            .get(`${baseURL}/transaction/stats/payment-type`, { withCredentials: true })
            .catch(() => ({ data: { data: [] } })),
          axios
            .get(`${baseURL}/transaction/stats/monthly`, { withCredentials: true })
            .catch(() => ({ data: { data: [] } })),
          axios
            .get(`${baseURL}/transaction?page=1&limit=10`, { withCredentials: true })
            .catch(() => ({ data: { data: [] } })), // recent 5
        ]);
                ...
                <div className="space-y-4">
                  {recentTransactions.map((transaction) => (
                    ...
                    >
                      ...
                      <p className={`font-semibold ${transaction.category === 'expense' ? 'text-red-400' :
